...
const COURSES = [
  {
    ...
    totalLessons: 3, estimatedHours: '40 min', color: '#22c55e',
    ...
    lessons: [
      { id:'basics-0', order:1, isPro:false, title:'Introduction to Animation', duration:'10:00', videoUrl:'https://youtu.be/MIQKA83ijvg',
      ...
      { id:'basics-1', order:2, isPro:false, title:'Getting Started with FlipaClip', duration:'10:00', videoUrl:'https://youtu.be/kXBAKw1VIiM',
      ...
      { id:'basics-2', order:3, isPro:false, title:'Bouncing Ball Animation', duration:'20:00', videoUrl:'https://youtu.be/oIncJCr88Lo',
  ...
  },
  {
    ...
    totalLessons: 3, estimatedHours: '60 min', color: '#3B82F6',
    ...
    lessons: [
      { id:'character-1', order:1, isPro:false, title:'Drawing the Background', duration:'20:00', videoUrl:'https://youtu.be/e0sExsCWSNg',
      ...
      { id:'character-2', order:2, isPro:true,  title:'Drawing the Characters', duration:'20:00', videoUrl:'https://youtu.be/th_gC1ZNaEE',
        description:'Discover how to bring characters to life through drawing. Learn the basics of sketching simple figures and expressions, step by step, and see how these drawings become the foundation of your animations in flipaclip.' },
      { id:'character-3', order:3, isPro:true,  title:'Animating the Characters', duration:'20:00', videoUrl:'https://youtu.be/plCGQOlE9hk',
        description:'Discover how to animate your characters in flipaclip, Learn the basics of frame by frame animation, add see how characters come alive with movement and personality, the perfect step after learning how to draw your characters.' },
    ],
  },
  {
    ...
    lessons: [
      { id:'lipsync-1', order:1, isPro:false, title:'Introduction to Lipsync', duration:'10:00', videoUrl:'https://youtu.be/VZK6DpTEZ1A',
      ...
      { id:'lipsync-2', order:2, isPro:true,  title:'Breaking Down Audio', duration:'10:00', videoUrl:'https://youtu.be/0-esr36Ig6Q',
        description:'make your drawings talk, read the waveform, break a line of dialogue into individual sounds, and map each sound to the correct mouth shape frame by frame.' },
      { id:'lipsync-3', order:3, isPro:true,  title:'Lip Sync Animation', duration:'10:00', videoUrl:'https://youtu.be/SaX3iYEvHq8',
        description:'Animate a complete talking character scene with synced mouth shapes, export your animation, and share your polished animation, convincing performance from start to finish.' },
    ],
  },
];
...
function renderLessonPlayer(lesson, course) {
  ...
  document.getElementById('lesson-body').innerHTML = `
    ...
    <a class="files-card" href="https://wa.me/256745414641?text=${encodeURIComponent('Hi Mac Academy, I would like the project files for: ' + lesson.title + ' (' + course.title + ')')}" target="_blank" rel="noopener">
      ...
      <div class="files-text">
        <div class="files-title">Need the project files?</div>
        <div class="files-sub">Tap to request on WhatsApp</div>
      </div>
      <div class="files-arrow">
