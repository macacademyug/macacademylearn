...
const COURSES = [
  {
    ...
    lessons: [
      ...
      { id:'basics-2', order:2, isPro:false, title:'Bouncing Ball Animation', duration:'15:00', videoUrl:'https://www.youtube.com/watch?v=47c2EyOfsj4',
  ...
  },
  {
    ...
    lessons: [
      { id:'character-1', order:1, isPro:false, title:'Drawing the Background', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=sP1C1fHMkds',
      ...
      { id:'character-2', order:2, isPro:true,  title:'Animating the Character', duration:'20:00', videoUrl:'https://www.youtube.com/watch?v=_niBNQevRZY',
      ...
      { id:'character-3', order:3, isPro:true,  title:'Finalizing Your Scene', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=FDJ6Iv6bq7s',
  ...
  },
  {
    ...
    lessons: [
      { id:'lipsync-1', order:1, isPro:false, title:'Understanding Mouth Shapes', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=rfKkoht0XvQ',
      ...
      { id:'lipsync-2', order:2, isPro:true,  title:'Breaking Down Audio', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=Mx9yJf0-5-Q',
  ...
  },
  {
    ...
    description: 'Edit professional-looking videos on your phone using CapCut — from basic cuts to keyframing, background removal, and everything in between.',
    totalLessons: 6, estimatedHours: '1 hr', color: '#06B6D4',
    ...
    lessons: [
      { id:'capcut-1', order:1, isPro:false, title:'Importing Footage & CapCut Overview', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=aI9I9_Xt330',
        description:'Learn how to bring in clips, organise your workspace, and get comfortable with the CapCut editing environment — the perfect starting point for any new editor.' },
      { id:'capcut-2', order:2, isPro:false, title:'Basic Editing Controls & Adding Music', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=e2R3sZLYubw',
        description:'Master trimming, arranging clips, and syncing your video with audio for polished storytelling. You will also learn how to add and adjust background music.' },
      { id:'capcut-3', order:3, isPro:true,  title:'Cutting to Beats & Adding Transitions', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=QfzU0xNEg1I',
        description:'Discover rhythm-based editing and smooth scene changes to make your edits flow naturally. Learn how to cut on the beat and pick transitions that match your style.' },
      { id:'capcut-4', order:4, isPro:true,  title:'Text, Auto Captions & Animating Text', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=gWzzZipHKp4',
        description:'Add accessibility and creative flair with auto-generated captions, titles, and animated text elements that keep viewers engaged from first frame to last.' },
      { id:'capcut-5', order:5, isPro:true,  title:'Color Correction & Transcript Editing', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=VAzRKql3vpY',
        description:'Elevate video quality with color grading tools and speed up your workflow using CapCut\'s transcript-based editing to cut silence and fix mistakes in seconds.' },
      { id:'capcut-6', order:6, isPro:true,  title:'Keyframing Motion & Background Removal', duration:'10:00', videoUrl:'https://www.youtube.com/watch?v=ex0NwMcf8iE',
